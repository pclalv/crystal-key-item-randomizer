defmodule SwapGenerator.Reachability do
  ...
  defp ss_locked?(swaps) do
    state_machine = Diet.Stepper.new(SwapGenerator.Reachability.SSLocked, nil)
  ...
  defp kanto_locked?(swaps) do
    state_machine = Diet.Stepper.new(SwapGenerator.Reachability.KantoLocked, nil)
  ...
  defp goldenrod_locked?(swaps) do
    state_machine = Diet.Stepper.new(SwapGenerator.Reachability.GoldenrodLocked, nil)
  ...
  defp surf_locked?(swaps) do
    state_machine = Diet.Stepper.new(SwapGenerator.Reachability.SurfLocked, nil)
  ...
  defp tree_locked?(swaps) do
    state_machine = Diet.Stepper.new(SwapGenerator.Reachability.TreeLocked, nil)
