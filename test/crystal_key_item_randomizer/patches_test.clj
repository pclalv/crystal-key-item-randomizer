...
(deftest replace-underground-warehouse-ultra-ball-with-key-item-test
  (testing "when speedchoice"
    (is (= {"integer_values" {"old" ["*" 1]
            ...
            "description" "Change the contents of the item ball from ULTRA_BALL to CARD_KEY; for real, this needs to be whatever replaces the CARD_KEY. integer_values.new doesn't exist so that things will fail hard if the patches aren't update properly"}
